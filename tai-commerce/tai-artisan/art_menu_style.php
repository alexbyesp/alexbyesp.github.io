...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="art_ventas.php">
            ...
            <li class="nav-item">
                ...
                <div id="collapseMateriales" class="collapse" aria-labelledby="headingMateriales" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="art_table_produ.php">Tabla de Productos</a>
                        <a class="collapse-item" href="art_registro_produ.php">Registrar Producto</a>
                    </div>
                </div>
            </li>
