...
<head>
    ...
    <title>Artesano: Inicio de Sesión</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">¡Bienvenido Artesano!</h1>
                                    </div>
                                    <form class="user" method="POST" action="sql_query_php/art_login.php">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                name="artesano_email" aria-describedby="emailHelp"
