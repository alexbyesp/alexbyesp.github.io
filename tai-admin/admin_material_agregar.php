...
<head>
    ...
    <title>Panel de Control: Crear Material</title>
</head>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Crear Nuevo Material</h1>
                    <form action="sql_query_php/admin_material_insert.php" method="POST">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Nombre:</label>
                                <input name="material_nombre" type="text" class="form-control" placeholder="Nombre del Material" required maxlength="20">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Descripción:</label>
                                <textarea name="material_descrip" class="form-control" rows="5" placeholder="Descripción" required maxlength="255"></textarea>
                            </div>
                        </div>
                        <div align="center"><br>
                            <button type="submit" class="btn btn-success btn-icon-split">
                                ...
                                <span class="text">Crear Material</span>
                            </button>
                        </div>
                    </form>
                </div>
