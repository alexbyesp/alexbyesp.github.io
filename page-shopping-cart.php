<?php
  $conexion=mysqli_connect('localhost','root','','tai_test');
?>
<!DOCTYPE HTML>
<html lang="en">

<!-- Mirrored from bootstrap-ecommerce.com/bootstrap-ecommerce-html/page-shopping-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Oct 2021 02:56:55 GMT -->
<head>
<meta charset="utf-8">
	...
	<td>
		<figure class="itemside">
			...
			<figcaption class="info">
                <?php echo $mostrar ['producto_nombre'] ?>
			</figcaption>
		</figure>
	</td>
	<td> 
        <?php echo $mostrar ['carrito_cantidad'] ?>
	</td>
	<td> 
		<div class="price-wrap"> 
            <?php echo $mostrar ['producto_precio'] ?> 
		</div> <!-- price-wrap .// -->
	</td>
	<td class="text-right"> 
...
<!-------------------------------Hasta Aqui Termina la Tabla de Productos----------------------------->
